package com.example.composemusicplayer.player.notification
...
class JetNotificationManager @Inject constructor(
    ...
    // this will help to control music from notification
